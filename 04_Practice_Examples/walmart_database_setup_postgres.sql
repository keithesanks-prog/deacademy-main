-- ============================================
-- WALMART LOYAL CUSTOMERS - POSTGRESQL VERSION
-- ============================================

-- Drop existing tables if they exist
DROP TABLE IF EXISTS walmart_reviews CASCADE;
DROP TABLE IF EXISTS walmart_orders CASCADE;
DROP TABLE IF EXISTS walmart_customers CASCADE;
...
INSERT INTO walmart_customers (customer_id, customer_name, email, signup_date) VALUES
...
CREATE TABLE walmart_orders (
    ...
    customer_id INTEGER REFERENCES walmart_customers(customer_id),
    order_date DATE,
    total_amount DECIMAL(10,2)
);

INSERT INTO walmart_orders (order_id, customer_id, order_date, total_amount) VALUES
...
INSERT INTO walmart_reviews (review_id, customer_id, product_name, rating, review_date) VALUES
...
SELECT 'Customers: ' || COUNT(*) as info FROM walmart_customers
UNION ALL SELECT 'Orders: ' || COUNT(*) FROM walmart_orders
UNION ALL SELECT 'Reviews: ' || COUNT(*) FROM walmart_reviews;
